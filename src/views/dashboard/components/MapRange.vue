  ...
  <div class="body">
    ...
    <div class="input-card">
      ...
      <div class="input-item">
        ...
        <select id="province" style="width:100px" @change="search('province')" />
      </div>
      <div class="input-item">
        <div class="input-item-prepend"><span class="input-item-text">地级市</span></div>
        <select id="city" style="width:100px" @change="search('city')" />
      </div>
      <div class="input-item">
        <div class="input-item-prepend"><span class="input-item-text">区县</span></div>
        <select id="district" style="width:100px" @change="search('district')" />
      </div>
    </div>
  </div>
</template>
